...
def show_about_me():
    ...
    # Create a two-column layout for the top images and a single-column layout for the bottom image
    col1, col2 = st.columns([1, 1])

    # Top row images: Wedding Reception and SuShi Plus Rishi side by side
    with col1:
    ...
    # Bottom row image: Rob Rishi Housewarming
    st.image('https://raw.githubusercontent.com/puravpatel3/portfolio/main/files/Rob_Rishi_Housewarming.jpg', width=600)
